...
with st.sidebar:
    ...
    manual_forecast_growth = st.slider(
        "Manual Annual FCFF Growth",
        -0.05,
        0.15,
        0.05,
        0.01,
    ...
    manual_terminal_growth = st.slider(
        "Manual Terminal Growth",
        0.00,
        0.05,
        0.025,
        0.005,
...
try:
    ...
    wacc_col2.metric(
        ...
        f"{wacc_details['pre_tax_cost_of_debt']:.2%}",
    )
    wacc_col2.metric(
        "After-Tax Cost of Debt",
        f"{wacc_details['after_tax_cost_of_debt']:.2%}",
    )
    ...
    growth_col1.metric(
        "Historical FCFF CAGR",
        f"{fcff_growth_details['fcff_cagr']:.2%}",
    )
    growth_col2.metric(
        "Revenue CAGR",
        f"{fcff_growth_details['revenue_cagr']:.2%}",
    )
    growth_col3.metric(
        "Terminal Growth",
        f"{selected_terminal_growth:.2%}",
